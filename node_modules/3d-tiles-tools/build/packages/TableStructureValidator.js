...
exports.TableStructureValidator = void 0;
/**
...
class TableStructureValidator {
     ...
     */
    static validate(db, tableStructure) {
        ...
        if (actualColumns.length !== expectedColumns.length) {
            return (`Table ${tableStructure.name} must have ${expectedColumns.length} ` +
...
exports.TableStructureValidator = TableStructureValidator;
