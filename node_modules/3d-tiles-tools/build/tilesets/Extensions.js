...
class Extensions {
     ...
     */
    static containsExtension(extended, extension) {
     ...
     * @param extension The extension (i.e. its name as a string)
     */
    static removeExtension(extended, extension) {
        if (!extended.extensions) {
            return;
        }
     ...
     */
    static addExtensionUsed(extensible, extension) {
     ...
     * @param extension - The extension name
     */
    static removeExtensionUsed(extensible, extension) {
     ...
     * @param extension - The extension name
     */
    static addExtensionRequired(extensible, extension) {
     ...
     * @param extension - The extension name
     */
    static removeExtensionRequired(extensible, extension) {
     ...
     */
    static addUniqueTo(object, key, element) {
     ...
     * @param element - The element
     */
    static removeFrom(object, key, element) {
