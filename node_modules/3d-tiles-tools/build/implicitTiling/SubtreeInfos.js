...
exports.SubtreeInfos = void 0;
const AvailabilityInfos_1 = require("./AvailabilityInfos");
const BinarySubtreeDataResolver_1 = require("./BinarySubtreeDataResolver");
/**
...
class SubtreeInfos {
     ...
     */
    static async createFromBuffer(input, implicitTiling, resourceResolver) {
        const binarySubtreeData = await BinarySubtreeDataResolver_1.BinarySubtreeDataResolver.resolveFromBuffer(input, resourceResolver);
     ...
     */
    static async createFromJson(subtree, implicitTiling, resourceResolver) {
        const binarySubtreeData = await BinarySubtreeDataResolver_1.BinarySubtreeDataResolver.resolveFromJson(subtree, resourceResolver);
        const result = SubtreeInfos.create(binarySubtreeData, implicitTiling);
        return result;
    }
    /**
     ...
     */
    static create(binarySubtreeData, implicitTiling) {
        ...
        const tileAvailabilityInfo = AvailabilityInfos_1.AvailabilityInfos.createTileOrContent(tileAvailability, bufferViewsData, implicitTiling);
        ...
        if (contentAvailabilities) {
            for (const contentAvailability of contentAvailabilities) {
                const contentAvailabilityInfo = AvailabilityInfos_1.AvailabilityInfos.createTileOrContent(contentAvailability, bufferViewsData, implicitTiling);
        ...
        const childSubtreeAvailabilityInfo = AvailabilityInfos_1.AvailabilityInfos.createChildSubtree(childSubtreeAvailability, bufferViewsData, implicitTiling);
        const result = {
...
exports.SubtreeInfos = SubtreeInfos;
