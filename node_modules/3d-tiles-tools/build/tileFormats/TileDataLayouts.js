...
exports.TileDataLayouts = void 0;
...
class TileDataLayouts {
    static create(buffer) {
        ...
        if (magic !== "b3dm" && magic !== "pnts" && magic !== "i3dm") {
            throw new TileFormatError_1.TileFormatError(`Expected magic "b3dm", "i3dm", or "pnts", but found "${magic}"`);
        }
        let headerLength = 28;
        if (magic === "i3dm") {
            headerLength = 32;
        ...
        if (buffer.length < headerLength) {
            throw new TileFormatError_1.TileFormatError(`Expected ${headerLength} bytes for ${magic} header, ` +
...
exports.TileDataLayouts = TileDataLayouts;
