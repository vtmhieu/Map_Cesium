...
class BinaryBuffers {
     ...
     */
    static createBinaryBufferStructure(binaryBufferData, newBufferViewsData) {
        const alignment = 8;
        ...
        for (let i = 0; i < newBufferViewsData.length; i++) {
            ...
            const requiredPadding = (alignment - (currentByteOffset % alignment)) % alignment;
            ...
            const bufferViewData = currentBufferData.subarray(currentByteOffset, currentByteOffset + newBufferViewData.length);
...
exports.BinaryBuffers = BinaryBuffers;
