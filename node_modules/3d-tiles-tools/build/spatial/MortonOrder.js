...
class MortonOrder {
    ...
    static encode2D(x, y) {
        ...
        return ((MortonOrder.insertOneSpacing(x) |
    ...
    static encode3D(x, y, z) {
        ...
        //>>includeEnd('debug');
        return (MortonOrder.insertTwoSpacing(x) |
