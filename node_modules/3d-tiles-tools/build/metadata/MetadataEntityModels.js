...
exports.MetadataEntityModels = void 0;
const defined_1 = require("../base/defined");
const DefaultMetadataEntityModel_1 = require("./DefaultMetadataEntityModel");
...
class MetadataEntityModels {
     ...
     */
    static create(schema, entity) {
        const classes = schema.classes;
        if (!classes) {
            throw new MetadataError_1.MetadataError(`Schema does not define any classes, ` +
                `but expected ${entity.class} to be defined`);
        }
        const metadataClass = classes[entity.class];
        if (!metadataClass) {
            throw new MetadataError_1.MetadataError(`Schema does not contain class ${entity.class}`);
        }
     ...
     * @returns The `MetadataEntityModel`
     */
    static createFromClass(metadataClass, entityProperties) {
        // TODO This should not be done for each entity. The lookup
        // should be computed once, and associated with the class.
        const semanticToPropertyId = MetadataEntityModels.computeSemanticToPropertyIdMapping(metadataClass);
        const metadataEntityModel = new DefaultMetadataEntityModel_1.DefaultMetadataEntityModel(metadataClass, semanticToPropertyId, entityProperties);
     ...
     * @returns The mapping
     */
    static computeSemanticToPropertyIdMapping(metadataClass) {
        ...
        if (classProperties) {
            for (const classPropertyId of Object.keys(classProperties)) {
                ...
                if ((0, defined_1.defined)(property.semantic)) {
...
exports.MetadataEntityModels = MetadataEntityModels;
