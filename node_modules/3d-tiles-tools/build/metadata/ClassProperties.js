...
exports.ClassProperties = void 0;
...
class ClassProperties {
     ...
     */
    static hasEffectivelyFloatingPointType(property) {
        const type = property.type;
        if (!MetadataTypes_1.MetadataTypes.numericTypes.includes(type)) {
            return false;
        }
        ...
        if (MetadataComponentTypes_1.MetadataComponentTypes.isIntegerComponentType(componentType)) {
            const normalized = property.normalized;
            if (!(0, defined_1.defined)(normalized)) {
                return false;
            }
            return normalized;
        }
     ...
     */
    static hasNumericType(property) {
        const type = property.type;
        if (!MetadataTypes_1.MetadataTypes.numericTypes.includes(type)) {
            return false;
        }
        ...
        if (!MetadataComponentTypes_1.MetadataComponentTypes.allComponentTypes.includes(componentType)) {
            return false;
        }
        return true;
    }
