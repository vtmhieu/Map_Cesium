...
exports.MetadataSemanticOverrides = void 0;
const defined_1 = require("../base/defined");
const MetadataEntityModels_1 = require("../metadata/MetadataEntityModels");
 ...
 * @internal
 */
class MetadataSemanticOverrides {
     ...
     */
    static applyExplicitTileMetadataSemanticOverrides(tile, schema) {
        ...
        try {
            metadataEntityModel = MetadataEntityModels_1.MetadataEntityModels.create(schema, metadata);
        }
        catch (error) {
     ...
     * schema and the metadata entity) are not structurally valid.
     */
    static applyExplicitContentMetadataSemanticOverrides(content, schema) {
     ...
     * schema and the metadata entity) are not structurally valid.
     */
    static applyImplicitTileMetadataSemanticOverrides(tile, tileIndex, subtreeMetadataModel) {
        if (subtreeMetadataModel.tileMetadataModel &&
            ...
            const metadataEntityModel = tileMetadataModel.getMetadataEntityModel(metadataIndex);
            MetadataSemanticOverrides.applyToTile(tile, metadataEntityModel);
        }
    }
    /**
     ...
     * schema and the metadata entity) are not structurally valid.
     */
    static applyImplicitContentMetadataSemanticOverrides(content, contentSetIndex, tileIndex, subtreeMetadataModel) {
        if (subtreeMetadataModel.contentMetadataModels &&
            ...
            const metadataIndex = subtreeMetadataModel.contentIndexMappings[contentSetIndex][tileIndex];
            const contentMetadataModel = subtreeMetadataModel.contentMetadataModels[contentSetIndex];
            const metadataEntityModel = contentMetadataModel.getMetadataEntityModel(metadataIndex);
            MetadataSemanticOverrides.applyToContent(content, metadataEntityModel);
        }
    }
    /**
     ...
     */
    static applyToTile(tile, metadataEntityModel) {
        const semanticBoundingBox = metadataEntityModel.getPropertyValueBySemantic("TILE_BOUNDING_BOX");
        if (semanticBoundingBox) {
            tile.boundingVolume.box = semanticBoundingBox;
        }
        const semanticBoundingRegion = metadataEntityModel.getPropertyValueBySemantic("TILE_BOUNDING_REGION");
        if (semanticBoundingRegion) {
            tile.boundingVolume.region = semanticBoundingRegion;
        }
        const semanticBoundingSphere = metadataEntityModel.getPropertyValueBySemantic("TILE_BOUNDING_SPHERE");
        if (semanticBoundingSphere) {
            tile.boundingVolume.sphere = semanticBoundingSphere;
        }
        const semanticGeometricError = metadataEntityModel.getPropertyValueBySemantic("TILE_GEOMETRIC_ERROR");
        if ((0, defined_1.defined)(semanticGeometricError)) {
            tile.geometricError = semanticGeometricError;
        }
        const semanticRefine = metadataEntityModel.getPropertyValueBySemantic("TILE_REFINE");
        if (semanticRefine === 0) {
            tile.refine = "ADD";
        }
        ...
        const semanticTransform = metadataEntityModel.getPropertyValueBySemantic("TILE_TRANSFORM");
     ...
     * @param metadataEntityModel - The `MetadataEntityModel`
     */
    static applyToContent(content, metadataEntityModel) {
        const semanticBoundingBox = metadataEntityModel.getPropertyValueBySemantic("CONTENT_BOUNDING_BOX");
        if (semanticBoundingBox) {
        ...
        const semanticBoundingRegion = metadataEntityModel.getPropertyValueBySemantic("CONTENT_BOUNDING_REGION");
        if (semanticBoundingRegion) {
            if (!content.boundingVolume) {
                content.boundingVolume = {};
            }
        ...
        const semanticBoundingSphere = metadataEntityModel.getPropertyValueBySemantic("CONTENT_BOUNDING_SPHERE");
        if (semanticBoundingSphere) {
            if (!content.boundingVolume) {
                content.boundingVolume = {};
            }
        ...
        const semanticUri = metadataEntityModel.getPropertyValueBySemantic("CONTENT_URI");
        if ((0, defined_1.defined)(semanticUri)) {
            content.uri = semanticUri;
        }
        const semanticGroupId = metadataEntityModel.getPropertyValueBySemantic("CONTENT_GROUP_ID");
        if ((0, defined_1.defined)(semanticGroupId)) {
            content.group = semanticGroupId;
        }
    }
}
exports.MetadataSemanticOverrides = MetadataSemanticOverrides;
