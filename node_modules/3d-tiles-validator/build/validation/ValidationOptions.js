...
class ValidationOptions {
     ...
     * is not implemented.
     */
    get includeContentTypes() {
        return this._includeContentTypes;
    }
    set includeContentTypes(value) {
    ...
    static fromJson(json) {
        const options = Object.assign(new ValidationOptions(), json);
        return options;
    }
}
