 ...
 * @internal
 */
export declare class BinaryValidator {
    /**
     ...
     */
    static validateMinLength(path: string, name: string, minLength: number | bigint, actualLength: number | bigint, context: ValidationContext): boolean;
    /**
     ...
     * @returns Whether the length is valid
     */
    static validateLength(path: string, name: string, expectedLength: number | bigint, actualLength: number | bigint, context: ValidationContext): boolean;
    /**
     ...
     */
    static validateValue(path: string, name: string, expectedValue: any, actualValue: any, context: ValidationContext): boolean;
    /**
     ...
     * @returns Whether the value is valid
     */
    static validateAlignment(path: string, name: string, value: number | bigint, expectedAlignment: number | bigint, context: ValidationContext): boolean;
}
//# sourceMappingURL=BinaryValidator.d.ts.map