 ...
 */
export declare class MetadataValidationIssues {
    /**
     ...
     */
    static METADATA_INVALID_LENGTH(path: string, message: string): ValidationIssue;
    /**
     ...
     * @returns The `ValidationIssue`
     */
    static METADATA_INVALID_ALIGNMENT(path: string, message: string): ValidationIssue;
    /**
     ...
     * @returns The `ValidationIssue`
     */
    static METADATA_INVALID_OFFSETS(path: string, message: string): ValidationIssue;
    /**
     ...
     * @returns The `ValidationIssue`
     */
    static METADATA_VALUE_NOT_IN_RANGE(path: string, message: string): ValidationIssue;
    /**
     ...
     * @returns The `ValidationIssue`
     */
    static METADATA_VALUE_MISMATCH(path: string, message: string): ValidationIssue;
    /**
     ...
     * @returns The `ValidationIssue`
     */
    static METADATA_VALUE_REQUIRED_BUT_MISSING(path: string, propertyName: string): ValidationIssue;
    /**
     ...
     * @returns The `ValidationIssue`
     */
    static METADATA_SEMANTIC_UNKNOWN(path: string, propertyName: string, semantic: string): ValidationIssue;
    /**
     ...
     * @returns The `ValidationIssue`
     */
    static METADATA_SEMANTIC_INVALID(path: string, message: string): ValidationIssue;
    /**
     ...
     * @returns The `ValidationIssue`
     */
    static CLASS_PROPERTY_COMPONENT_TYPE_FOR_NON_NUMERIC_TYPE(path: string, componentType: string, theType: string): ValidationIssue;
    /**
     ...
     * @returns The `ValidationIssue`
     */
    static CLASS_PROPERTY_COMPONENT_TYPE_MISSING(path: string, theType: string): ValidationIssue;
    /**
     ...
     * @returns The `ValidationIssue`
     */
    static CLASS_PROPERTY_ENUMTYPE_WITH_NON_ENUM_TYPE(path: string, enumType: string, theType: string): ValidationIssue;
    /**
     ...
     * @returns The `ValidationIssue`
     */
    static CLASS_PROPERTY_ENUM_TYPE_WITHOUT_ENUMTYPE(path: string): ValidationIssue;
    /**
     ...
     * @returns The `ValidationIssue`
     */
    static CLASS_PROPERTY_ENUMTYPE_NOT_FOUND(path: string, enumType: string): ValidationIssue;
    /**
     ...
     * @returns The `ValidationIssue`
     */
    static CLASS_PROPERTY_ENUM_VALUE_NAME_NOT_FOUND(path: string, name: string, propertyName: string, enumType: string | undefined, enumValueName: string): ValidationIssue;
    /**
     ...
     * @returns The `ValidationIssue`
     */
    static CLASS_PROPERTY_COUNT_FOR_NON_ARRAY(path: string, propertyName: string): ValidationIssue;
    /**
     ...
     * @returns The `ValidationIssue`
     */
    static CLASS_PROPERTY_NORMALIZED_FOR_NON_NORMALIZABLE_TYPE(path: string, propertyName: string, propertyType: string): ValidationIssue;
    /**
     * Indicates that the 'normalized' property of a class property was
     ...
     * @returns The `ValidationIssue`
     */
    static CLASS_PROPERTY_NORMALIZED_FOR_NON_INTEGER_COMPONENT_TYPE(path: string, propertyName: string, componentType: string): ValidationIssue;
    /**
     ...
     * @returns The `ValidationIssue`
     */
    static METADATA_OFFSET_SCALE_FOR_NON_FLOATING_POINT_TYPE(path: string, propertyName: string, offsetOrScale: string, propertyType: string, componentType: string | undefined, normalized: boolean | undefined): ValidationIssue;
    /**
     ...
     * @returns The `ValidationIssue`
     */
    static METADATA_MIN_MAX_FOR_NON_NUMERIC_TYPE(path: string, propertyName: string, minOrMax: string, propertyType: string): ValidationIssue;
    /**
     ...
     * @returns The `ValidationIssue`
     */
    static CLASS_PROPERTY_INCONSISTENT(path: string, message: string): ValidationIssue;
    /**
     ...
     * @returns The `ValidationIssue`
     */
    static METADATA_PROPERTY_INVALID_FOR_VARIABLE_LENGTH_ARRAY(path: string, propertyName: string, invalidPropertyName: string): ValidationIssue;
    /**
     ...
     * @returns The `ValidationIssue`
     */
    static CLASS_PROPERTIES_DUPLICATE_SEMANTIC(path: string, propertyNameA: string, propertyNameB: string, semantic: string): ValidationIssue;
    /**
     ...
     * @returns The `ValidationIssue`
     */
    static ENUM_VALUE_DUPLICATE_NAME(path: string, name: string): ValidationIssue;
    /**
     ...
     * @returns The `ValidationIssue`
     */
    static ENUM_VALUE_DUPLICATE_VALUE(path: string, value: number): ValidationIssue;
}
//# sourceMappingURL=MetadataValidationIssues.d.ts.map