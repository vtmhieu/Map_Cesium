...
exports.SemanticValidationIssues = void 0;
 ...
 */
class SemanticValidationIssues {
    /**
     ...
     */
    static ASSET_VERSION_UNKNOWN(path, message) {
     ...
     * @returns The `ValidationIssue`
     */
    static TILE_REFINE_WRONG_CASE(path, message) {
     ...
     * @returns The `ValidationIssue`
     */
    static TILE_IMPLICIT_ROOT_INVALID(path, message) {
     ...
     * @returns The `ValidationIssue`
     */
    static BOUNDING_VOLUME_INVALID(path, message) {
     ...
     * @returns The `ValidationIssue`
     */
    static BOUNDING_VOLUMES_INCONSISTENT(path, message) {
     ...
     * @returns The `ValidationIssue`
     */
    static PROPERTIES_MINIMUM_LARGER_THAN_MAXIMUM(path, message) {
     ...
     * @returns The `ValidationIssue`
     */
    static TILE_GEOMETRIC_ERRORS_INCONSISTENT(path, message) {
     ...
     * @returns The `ValidationIssue`
     */
    static TEMPLATE_URI_INVALID_VARIABLE_NAME(path, variableName, validVariableNames) {
        const type = "TEMPLATE_URI_INVALID_VARIABLE_NAME";
        const severity = ValidationIssueSeverity_1.ValidationIssueSeverity.ERROR;
        const names = ValidationIssueUtils_1.ValidationIssueUtils.joinNames("and", ...validVariableNames);
        const message = `The template URI refers to the variable '${variableName}', but ` +
     ...
     * @returns The `ValidationIssue`
     */
    static TEMPLATE_URI_MISSING_VARIABLE_NAME(path, missingVVariableNames) {
        const type = "TEMPLATE_URI_MISSING_VARIABLE_NAME";
        const severity = ValidationIssueSeverity_1.ValidationIssueSeverity.WARNING;
        const names = ValidationIssueUtils_1.ValidationIssueUtils.joinNames("and", ...missingVVariableNames);
     ...
     * @returns The `ValidationIssue`
     */
    static IMPLICIT_TILING_ERROR(path, message) {
     ...
     * @returns The `ValidationIssue`
     */
    static BUFFERS_INCONSISTENT(path, message) {
     ...
     * @returns The `ValidationIssue`
     */
    static SUBTREE_AVAILABILITY_INCONSISTENT(path, message) {
     ...
     * @returns The `ValidationIssue`
     */
    static TRANSFORM_INVALID(path, message) {
     ...
     * @returns The `ValidationIssue`
     */
    static EXTENSION_REQUIRED_BUT_NOT_USED(path, extensionName) {
        const type = "EXTENSION_REQUIRED_BUT_NOT_USED";
        const severity = ValidationIssueSeverity_1.ValidationIssueSeverity.ERROR;
        const message = `The extension '${extensionName}' was declared in ` +
     ...
     * @returns The `ValidationIssue`
     */
    static EXTENSION_FOUND_BUT_NOT_USED(path, extensionName) {
        const type = "EXTENSION_FOUND_BUT_NOT_USED";
        const severity = ValidationIssueSeverity_1.ValidationIssueSeverity.ERROR;
        const message = `The extension '${extensionName}' was found, but not ` +
     ...
     * @returns The `ValidationIssue`
     */
    static EXTENSION_USED_BUT_NOT_FOUND(path, extensionName) {
     ...
     * @returns The `ValidationIssue`
     */
    static EXTENSION_NOT_SUPPORTED(path, extensionName) {
...
exports.SemanticValidationIssues = SemanticValidationIssues;
