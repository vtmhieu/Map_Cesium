...
class GltfValidator {
     ...
     */
    static createValidationIssueFromGltfMessage(gltfMessage) {
        ...
        const issue = ContentValidationIssues_1.ContentValidationIssues.CONTENT_VALIDATION_INFO(path, message);
        return issue;
    }
    /**
    ...
    async validateObject(uri, input, context) {
        ...
        if (gltfResult.issues.numErrors > 0) {
            ...
            for (const gltfMessage of gltfResult.issues.messages) {
                ...
                const cause = GltfValidator.createValidationIssueFromGltfMessage(gltfMessage);
