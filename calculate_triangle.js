...
// Read the glTF file
const gltfData = fs.readFileSync(
	"/home/hieuvu/DATN/Map_Cesium/gltf/Gear2.gltf",
	"utf8",
);
	...
	object.meshes.forEach((mesh) => {
		mesh.primitives.forEach((primitive) => {
			...
			const positionBufferView =
				object.bufferViews[positionAccessor.bufferView];
...
function countTrianglesInTile(gltf, rootNode, boundingBox) {
	...
	processNode(gltf.nodes[rootNode]);
